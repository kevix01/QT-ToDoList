...
void IOManagerTest::splitMethodTest(){
    std::string testInput = std::string("2001/07/25")+IOManager::regexChar+"Testing Title"+IOManager::regexChar+"100"+IOManager::regexChar+"Testing Description"+IOManager::regexChar+"Testing List";
    std::vector<string> testOutput = IOManager::split(testInput, IOManager::regexChar);
    //checking vector size
    QCOMPARE(testOutput.size(), 5);
    ...
    QCOMPARE(testOutput.at(4), "Testing List");
}
...
void IOManagerTest::readFileMethodTest(){
    ...
    QCOMPARE(outputDb.at(0)[4], "Test List 1");
    ...
    QCOMPARE(outputDb.at(1)[4], "Test List 2");
    ...
    QCOMPARE(outputDb.at(2)[4], "Test List 3");
}
